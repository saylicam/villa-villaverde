    ...
    <>
      ...
      <Section id="suites" tone="sand">
        <div className="text-center max-w-3xl mx-auto">
          <Reveal>
            <h2 className="title-display h2">Deux suites — ou la villa entière</h2>
          </Reveal>
          <Reveal delay={0.1}>
            <p className="lead mt-3">
              Louez au choix <b>Mirador</b> (étage haut) ou <b>Jardin</b> (niveau
              piscine). Privatisez toute la villa pour réunir famille &amp; amis.
            </p>
          </Reveal>
        </div>
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          {[
            ...
            },
            {
              ...
              link: "/suites/villa",
              bullets: [
                "2 niveaux communicants",
                "6 chambres en suite (6+7 pers)",
                "300 m² au total",
                "Idéal familles & réunions",
              ],
            },
          ].map((c, i) => (
              ...
              <TiltCard>
                ...
                >
                  ...
                  <div className="-mt-7 md:-mt-8 p-5 bg-white/85 backdrop-blur-md ring-1 ring-[color:var(--line)] shadow-soft">
                    ...
                    <div className="title-serif text-lg font-semibold mt-1">
                      {c.title}
                    </div>
      ...
      <Section id="activites" tone="sand">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="lead mt-2">
            À quelques minutes — de quoi varier rythmes et horizons.
          </p>
        </div>
      ...
      {/* 7.5) INFOS / FAQ */}
      <Section id="infos" tone="sand">
        <div className="max-w-3xl mx-auto">
          <h2 className="title-display h2 text-center">Infos & FAQ</h2>
          <div className="mt-6">
            <Accordion
              items={[
                {
                  title: "Capacité & configuration",
                  content:
                    "Bas 120 m² (6 pers). Haut 180 m² (7 pers). Chaque niveau dispose de 3 chambres en suite.",
                  defaultOpen: true,
                },
                { title: "Arrivée & départ", content: "Arrivée 16:00 – Départ 10:00." },
                {
                  title: "Règles",
                  content:
                    "Non-fumeur. Animaux non autorisés. Pas d’évènements.",
                },
              ]}
            />
          </div>
